...
We began with the question, "does altitude correlate with the mass to length ratio?" When first taking a look at the data we found that a frequency plot of our
